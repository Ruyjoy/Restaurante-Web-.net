...
<span style="margin: 5px; padding: 5px; border: solid 1px #CCCCCC; background-color: #EEEEEE;">
    día: 
    <asp:DropDownList ID="ddlDia" AutoPostBack="false" runat="server">
    </asp:DropDownList>
    
    mes:
    <asp:DropDownList ID="ddlMes" AutoPostBack="false" runat="server">
    </asp:DropDownList>
    
    año:
    <asp:DropDownList ID="ddlAnio" AutoPostBack="false" runat="server">
    </asp:DropDownList>
</span>
